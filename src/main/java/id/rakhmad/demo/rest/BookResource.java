...
public class BookResource {
        ...
        public BookResource() {
                ...
                books.add(new Book("The Pragmatic Programmer: Your Journey To Mastery", "David Thomas",
                                "978-0135957059", "‎Addison-Wesley Professional"));
                books.add(new Book("Design Patterns: Elements of Reusable Object-Oriented Software",
                                "Erich Gamma, et. al.", "978-0201633610", "‎Addison-Wesley Professional"));
                ...
                books.add(new Book("Working Effectively with Legacy Code", "Michael Fethers", "978-0131177055",
                                "‎Pearson"));
                books.add(new Book("Test Driven Development: By Example", "Kent Beck", "978-0321146533",
                                "‎ Addison-Wesley Professional"));
                books.add(new Book("Extreme Programming Explained: Embrace Change, 2nd Edition", "Kent Beck",
                                "978-0321278654", "‎Addison-Wesley Professional"));
